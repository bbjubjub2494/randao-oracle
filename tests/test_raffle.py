...
def test_raffle(raffle_factory_contract, n_players, blocks_to_mine, mix_hash):
    ...
    raffle_contract = raffle_factory_contract.create(players, value=1)
    ...
    RaffleImplementation.at(raffle_contract).resolve(rlp.encode(header))
